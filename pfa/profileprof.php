...
$post = new post();
$prof=$_GET['id'];
$posts=$post->affichepostprof($_SESSION['id_eleve'],$prof);
...
<body>
    ...
    <div class="middle">
        <div  id="partiehaut">
            ...
            <a href="attente.php"><div id="menub">Photos </div></a>
            <div id="menub">Setting</div>
        </div>
            <div style="display: flex;">
                ...
                <div style="min-height:400px;flex:1;padding:20px;padding-right:0px;padding-top:0px;">
