...
<head>
    ...
    <title>Invitations en attente</title>
...
<body>
    ...
    <div class="middle">
        <div  id="partiehaut">
            ...
            <a href="attente.php"><div id="menub" style="border-bottom: 2px solid blue;">Invitations en attente </div></a>
        </div>
            <div id="partiebas">
                
                    <div id="friendbar"><div id="friend-header">Mes invitations en attente<br></div>
                    <?php  
